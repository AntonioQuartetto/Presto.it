    ...
    <div class="row d-flex justify-content-center">
        @foreach ($categories as $category)
            <div class="col-12 col-md-4">
                <a href="{{ route('categoryShow', compact('category')) }}" class="dropdown-item d-flex justify-content-center">
