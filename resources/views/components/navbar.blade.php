                ...
                <ul class="my-ul navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <form action="{{route('announcement.search')}}" method="GET" class="form-inline d-flex">
                            <input class="form-control" type="search" id="cerca-per-nome" name="searched" placeholder="Cerca un articolo">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle active text-warning" href="#"
