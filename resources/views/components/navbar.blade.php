    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="my-ul navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item  my-li"><x-_locale lang="it" nation="it"/></li>
                <li class="nav-item my-li"><x-_locale lang="en" nation="gb"/></li>
                <li class="nav-item  my-li"><x-_locale lang="es" nation="es"/></li>    
            </ul>
            <ul class="my-ul navbar-nav me-auto mb-2 mb-lg-0">
