                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                        <div class="form-outline flex-fill mb-0">
                            <label class="form-label" for="name">{{__('ui.authRegister_2')}}</label>
                    ...
                    <div class="container">  
                        <div class="d-grid my-3">
                            <button type="submit" class="btn-user fw-bold py-2" style="">{{__('ui.authRegister')}}</button>
                        </div>
                    <div class="d-grid">       
                        <a href="{{route('login')}}" class="btn-user fw-bold py-2 text-center" style="">{{__('ui.authRegister_4')}}</a>
                    </div>                                        
                    </div>                                   
                </form>      
            </div>
            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                <img src="{{Storage::url('\images\announcementsHeader.jpg')}}" class="img-fluid border border-2 border-dark rounded" alt="Open">
            </div>
        </div>
    </div>
</x-template>
